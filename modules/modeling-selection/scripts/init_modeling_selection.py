...
def empty_payloads(intake: dict[str, Any], audit: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "model-decision.yaml": {"schema_version": SCHEMA_VERSION, "status": "EXPLORATORY", "scope_subproblem_ids": scope, "main_candidate_ids": [], "baseline_candidate_ids": [], "alternative_candidate_ids": [], "baseline_exception": None, "alternative_exception": None, "comparisons": [], "coverage": {"requirement_ids": [], "difficulty_refs": [], "subproblem_ids": scope}, "decision_rationale": "当前处于探索阶段，尚未确定正式模型。", "residual_risks": []},
